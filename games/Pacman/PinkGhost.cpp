...
PinkGhost::PinkGhost(char name): Ghost(name)
{
    _incTime = 40;
}

PinkGhost::PinkGhost(char name, int x, int y): Ghost(name, x, y)
{
    _incTime = 40;
}
...
void PinkGhost::move(std::vector<std::string> map)
{
...
void PinkGhost::AI(std::vector<std::string> map)
{
